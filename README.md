...
const aswath-tamilan = {
    ...
    currentlyBuilding: "SaaS platforms, CRMs & AI-powered business automation tools 🤖",
    currentlyLearning: ["Cloud-native architecture", "AI / LLM integrations", "System design at scale"],

    funFact: "Shipped 20+ production apps — from Publication Management to AI automation 🚀",
...
<details open>
<summary><b>🚀 Full Stack Developer — Botlytix Technologies (Present)</b></summary>
<br>

- 🏗️ Developed scalable enterprise-level web applications end-to-end
- 🔗 Built REST APIs using **Node.js** and **Express.js**
- 🎨 Designed responsive, production-grade UIs using **Angular** and **React**
- 🗄️ Integrated **PostgreSQL** databases with optimized queries
- 🔐 Implemented **authentication and authorization** (JWT, role-based access control)
- ☁️ Developed complete **SaaS solutions** and deployed production apps on **VPS servers**
- ⚙️ Configured **Nginx**, **PM2**, and **SSL certificates** for secure, reliable deployments
- 🐛 Optimized frontend performance and resolved production bugs for greater stability
...
|:---:|:---:|:---|
| 📚 **RDG Publication Management System** | Angular · Node.js · Express · PostgreSQL · Nginx · PM2 | Publication, book, category & customer management with role-based login, admin dashboard & live production deployment |
| 📞 **TeleCall SaaS** | Angular · Flutter · Node.js · PostgreSQL | Employee tracking, call logs, attendance & meeting reports with subscription management, analytics & mobile integration |
| 🤖 **AI Business Automation Platform** | Angular · Node.js · Express · PostgreSQL | AI chat integration, lead automation, workflow automation & real-time business dashboard |
| 👥 **HR Management System** | Angular · Node.js · Express · PostgreSQL | Employee management, attendance tracking, payroll processing, leave management & reporting |
| 📈 **CRM Platform** | Angular · Node.js · Express · PostgreSQL | Customer management, lead tracking, role management, sales dashboard & analytics |
| 🏢 **Business Listing Platform** | Angular · Node.js · Express · PostgreSQL | Business profiles, category browsing, search, admin panel & SEO optimization |
...
| Category | Details |
|:---:|:---|
| 🛠️ **Projects Delivered** | 20+ real-world projects — SaaS, CRM, HRM, E-Commerce, Business Listing & AI platforms |
| 📜 **Certifications** | JavaScript · Angular · React · Node.js |
| 🌐 **Languages Spoken** | English, Tamil |
| 🤝 **Core Strengths** | Problem Solving · Leadership · Communication · Team Collaboration · Time Management · Adaptability |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white&labelColor=0D1117)](https://linkedin.com/in/dalin-johnson-a-090304-)
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white&labelColor=0D1117)](mailto:dalinjohnson3@gmail.com)
